...
src_files = "/harddisk/user/keminglu/pretrained_data_wikipedia_with_mention/*"
output_dir = "/harddisk/user/keminglu/pretrained_data_processed/wikipedia_with_mention_wo_title_simplified/"
